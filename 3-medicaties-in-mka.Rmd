...
+--------------+--------+--------+-----------------------------------+
| Pregab       | Rating | RCTs   | Clinical practice experience      |
| ali          | of     |        | concerning combinations           |
| n/gabapentin | ev     |        |                                   |
| combined     | idence |        |                                   |
| with:        |        |        |                                   |
+:=============+:=======+:=======+:==================================+
| TCAs         | I + A  | Gilron | Combination well documented. Most |
|              |        | et     | with peripheral NeP. Useful       |
|              |        | al10   | combination for patients who do   |
|              |        | and    | not tolerate either drug in       |
|              |        | H      | larger doses, as well as sedative |
|              |        | olbech | effect from TCA to improve sleep  |
|              |        | et     | disturbance                       |
|              |        | al11   |                                   |
+--------------+--------+--------+-----------------------------------+
| SNRIs        | I/II + | T      | Combination reasonably well       |
|              | B/C    | esfaye | documented. Used by some of the   |
|              |        | et     | experts with good effect and      |
|              |        | al12   | fewer side effects than with TCA  |
|              |        | and Ta |                                   |
|              |        | n      |                                   |
|              |        | n      |                                   |
|              |        | enberg |                                   |
...
|              |        | al13   |                                   |
+--------------+--------+--------+-----------------------------------+
| SSRIs        | III +  | None   | Insufficient evidence available.  |
|              | C      |        | SSRIs not relevant in the         |
|              |        |        | treatment of NeP                  |
+--------------+--------+--------+-----------------------------------+
| Opioids      | I + B  | Gilron | Good evidence to support          |
|              |        | et     | combination therapy. Frequently   |
|              |        | al16,  | used in daily clinical practice   |
|              |        | Hanna  |                                   |
|              |        | et     |                                   |
|              |        | al17   |                                   |
|              |        | and C  |                                   |
...
| an           |        |        | Combination could work in theory  |
| tiepileptics |        |        | due to different mechanisms of    |
| (Na+ channel |        |        | action. Limited clinical          |
| blockers)    |        |        | experience                        |
+--------------+--------+--------+-----------------------------------+
| Cutaneous    | I +    | Casale | Mixed evidence and results for    |
| patches      | A/C    | et     | localized NeP. Patches add-on to  |
|              |        | al,19  | oral therapy are used by some     |
|              |        | Meier  | experts with good effect          |
|              |        | et     |                                   |
|              |        | al20   |                                   |
|              |        | and    |                                   |
|              |        | Irving |                                   |
...
|              |        | al21   |                                   |
+--------------+--------+--------+-----------------------------------+
| Others       | C      | None   | Insufficient evidence and         |
