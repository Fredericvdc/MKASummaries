...
+:========+:========+:========+:========+:========+:========+:========+
| 32 mg   | 32mg    | 16 mg   | 16 mg   | 8 mg    | 8 mg    | 4 mg    |
...
+-----------------+----------+----------+-----------------------------------------+
| Pregab          | Rating   | RCTs     | Clinical practice experience concerning |
| alin/gabapentin | of       |          | combinations                            |
...
|                 |          | et al13  |                                         |
+-----------------+----------+----------+-----------------------------------------+
| SSRIs           | III + C  | None     | Insufficient evidence available. SSRIs  |
|                 |          |          | not relevant in the treatment of NeP    |
+-----------------+----------+----------+-----------------------------------------+
| Opioids         | I + B    | Gilron   | Good evidence to support combination    |
|                 |          | et al16, | therapy. Frequently used in daily       |
...
| antiepileptics  |          |          | Combination could work in theory due to |
| (Na+ channel    |          |          | different mechanisms of action. Limited |
| blockers)       |          |          | clinical experience                     |
+-----------------+----------+----------+-----------------------------------------+
| Cutaneous       | I + A/C  | Casale   | Mixed evidence and results for          |
| patches         |          | et al,19 | localized NeP. Patches add-on to oral   |
|                 |          | Meier et | therapy are used by some experts with   |
|                 |          | al20 and | good effect                             |
|                 |          | Irving   |                                         |
|                 |          | et al21  |                                         |
+-----------------+----------+----------+-----------------------------------------+
...
+------------------+------------------+------------------------------+
| Vaccinatiestatus | Oppervlakkige en | Wonde met risico van         |
|                  | schone wonde     | tetanus^1^                   |
+:=================+:=================+:=============================+
| Geen of onzekere | Volledige        | Volledige primovaccinatie2 + |
| vaccinatie       | pr               | specifieke                   |
|                  | imovaccinatie^2^ | immunoglobulinen^3^          |
+------------------+------------------+------------------------------+
