...
+:========+:========+:========+:========+:========+:=========+:===========+
| 64 mg   | 64 mg   | 64 mg   | 64 mg   | 32 mg   | 16 mg    | 8 mg       |
| Medrol® | Medrol® | Medrol® | Medrol® | Medrol® | Medrol®  | Medrol®    |
+---------+---------+---------+---------+---------+----------+------------+
...
|        |      | and      | patients who do not tolerate either drug |
|        |      | Holbech  | in larger doses, as well as sedative     |
|        |      | et al11  | effect from TCA to improve sleep         |
|        |      |          | disturbance                              |
+--------+------+----------+------------------------------------------+
| SNRIs  | I/II | Tesfaye  | Combination reasonably well documented.  |
|        | +    | et al12  | Used by some of the experts with good    |
|        | B/C  | and      | effect and fewer side effects than with  |
|        |      | Ta       | TCA                                      |
|        |      | nnenberg |                                          |
|        |      | et al13  |                                          |
+--------+------+----------+------------------------------------------+
...
| ioidsa | B    | et al16, | therapy. Frequently used in daily        |
...
| ckers) |      |          |                                          |
+--------+------+----------+------------------------------------------+
| Cut    | I +  | Casale   | Mixed evidence and results for localized |
| aneous | A/C  | et al,19 | NeP. Patches add-on to oral therapy are  |
| p      |      | Meier et | used by some experts with good effect    |
| atches |      | al20 and |                                          |
|        |      | Irving   |                                          |
|        |      | et al21  |                                          |
+--------+------+----------+------------------------------------------+
...
-   S/ 24 of 60 co Indicatie: Bij zenuwpijnen thv nek en rug, ook bij
    zona (in combinatie met primaril en trigeminus neuralgie)

### Primaril

-   R/ Primaril 27euro
-   Dt/ 1x/d, doos gedurende 3 maand ( mag tot 4x/d)
-   S/ 60 co Indicatie: verzwakte weerstand, acute en chornische virale
    infecties, griep,...
...
+:================+:=================+:===============================+
| Geen of         | Volledige        | Volledige primovaccinatie2 +   |
| onzekere        | pr               | specifieke immunoglobulinen^3^ |
| vaccinatie      | imovaccinatie^2^ |                                |
+-----------------+------------------+--------------------------------+
| Onvolledige     | Vaccinatieschema | Vaccinatieschema afwerken +    |
| primovaccinatie | afwerken         | specifieke immunoglobulinen^3^ |
+-----------------+------------------+--------------------------------+
| Volledige       | NA               | NA                             |
| primovaccinatie |                  |                                |
+-----------------+------------------+--------------------------------+
...
| vaccinatie \>   | vaccin           | specifieke immunoglobulinen^3^ |
| 10 jaar en \<   |                  |                                |
| 20 jaar         |                  |                                |
+-----------------+------------------+--------------------------------+
| -- Laatste      | 2 doses van het  | 2 doses van het vaccin met 6   |
| vaccinatie \>   | vaccin met 6     | maanden interval + specifieke  |
| 20 jaar         | maanden interval | immunoglobulinen^3^            |
+-----------------+------------------+--------------------------------+
